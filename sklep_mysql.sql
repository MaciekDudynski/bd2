...
-- UPDATE KLIENCI SET KLIENCI.MD5_LOGIN = getHashVal(KLIENCI.MD5_LOGIN) WHERE KLIENCI.ID_KLIENT = @klienci_id;
...
-- UPDATE PRACOWNICY SET PRACOWNICY.MD5_LOGIN = getHashVal(PRACOWNICY.MD5_LOGIN) WHERE PRACOWNICY.PRACOWNIK_ID = @pracownicy_id;
